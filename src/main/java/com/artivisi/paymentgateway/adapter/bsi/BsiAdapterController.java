 ...
 * exactly as the legacy service does. {@code BsiResponse}'s {@code NON_EMPTY} serialization drops the rest.
 */
@RestController
...
public class BsiAdapterController {
    ...
    private BsiResponse handlePayment(EscrowAccount escrow, BsiRequest request) {
        ...
        return echo(request)
                ...
                // createdAt — OUR apply moment, which is what the legacy service returns here and what the
